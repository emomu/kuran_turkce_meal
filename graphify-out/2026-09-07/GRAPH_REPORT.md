...
## Corpus Check
- 181 files · ~689,199 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2415 nodes · 3617 edges · 134 communities (124 shown, 6 thin omitted)
...
Cohesion: 0.07
Nodes (28): ../data/verse_reference.dart, ayahNumber, clear, copyWith, _debounce, dispose, hasQuery, hasReference (+20 more)
...
Cohesion: 0.08
Nodes (27): ../../../data/models/user_marks.dart, ayah, ayahById, ayahs, mark, marks, marksRepo, quran (+19 more)
...
Cohesion: 0.05
Nodes (47): GlobalKey?, PlanOrder, _ayahOfDayKey, _orderToggleKey, _surahSearchKey, _tourSteps, badgeKey, _firstBadgeKey (+39 more)
...
Cohesion: 0.05
Nodes (46): ../../audio/providers/download_provider.dart, ../../audio/widgets/audio_download_sheet.dart, CupertinoStyleLoader, _MetaChip, _ReaderAppBar, _ReaderError, _SurahHeader, _ActionTile (+38 more)
...
Cohesion: 0.07
Nodes (29): ../../../data/models/prophet.dart, _AppBar, ayah, _AyahEntry, ayahs, _Body, build, byId (+21 more)
...
Cohesion: 0.06
Nodes (36): AnimatedAlign, AnimatedDefaultTextStyle, Brightness, package:kuran_turkce_meal/core/theme/app_typography.dart, package:kuran_turkce_meal/features/bookmarks/providers/bookmarks_provider.dart, package:kuran_turkce_meal/features/bookmarks/view/bookmarks_screen.dart, package:kuran_turkce_meal/features/plans/view/plans_screen.dart, package:kuran_turkce_meal/features/settings/view/settings_screen.dart (+28 more)
...
Cohesion: 0.07
Nodes (28): ../../core/theme/app_typography.dart, ../../../data/models/plan_schedule.dart, ReadingStreak, color, completedDays, completions, day, _DayRow (+20 more)

### Community 25 - "VoidCallback?"
Cohesion: 0.06
Nodes (34): ../../../data/models/surah.dart, build, fraction, lastReadAyah, onTap, _ProgressBar, showRevelationOrder, _subtitle (+26 more)
...
### Community 34 - "_ReaderScreenState"
Cohesion: 0.23
Nodes (12): playSurahProvider, nextSurahProvider, readerDataProvider, saveProgressProvider, surahMarksProvider, _advanceToNextSurah, build, _onScroll (+4 more)
...
Cohesion: 0.10
Nodes (18): IconData, applyBottomSafeArea, _ControlButton, icon, isLoading, isPlaying, onTap, _PlayButton (+10 more)
...
Cohesion: 0.10
Nodes (20): QuranRoot, _buildResults, _controller, createState, dispose, isExpanded, isSelected, letter (+12 more)

### Community 51 - "plan_reader_screen.dart"
Cohesion: 0.05
Nodes (36): ../../audio/providers/audio_provider.dart, ../../audio/widgets/audio_player_bar.dart, ../../audio/widgets/day_download_sheet.dart, _advanceToNextDay, createState, dayIndex, dispose, initState (+28 more)

### Community 52 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.07
Nodes (33): AnimatedContainer, CustomPaint, main, package:flutter_riverpod/flutter_riverpod.dart, package:kuran_turkce_meal/core/providers/app_providers.dart, package:kuran_turkce_meal/features/onboarding/providers/tour_provider.dart, package:kuran_turkce_meal/features/onboarding/widgets/coach_mark.dart, package:kuran_turkce_meal/features/onboarding/widgets/tour_host.dart (+25 more)
...
Cohesion: 0.05
Nodes (41): all, ayahCount, ayahIds, ayahsPerDay, byId, copyWith, dayCount, descriptionKey (+33 more)
...
### Community 71 - "verse_reference.dart"
Cohesion: 0.11
...
Cohesion: 0.06
Nodes (34): DateTime, a, b, calculateStreak, calendarDaysBetween, completedDays, current, currentDay (+26 more)
...
### Community 87 - "surah_search_field.dart"
Cohesion: 0.21
Nodes (12): ConsumerState, surahQueryProvider, build, _clear, _controller, createState, dispose, initState (+4 more)

### Community 88 - "prophet.dart"
Cohesion: 0.20
...
### Community 90 - "preferencesProvider"
Cohesion: 0.22
...
### Community 92 - "State"
Cohesion: 0.20
Nodes (15): _NavItem, _NavItemState, CoachMarkOverlay, _CoachMarkOverlayState, NoteEditorSheet, _NoteEditorSheetState, _VersionTile, _VersionTileState (+7 more)
...
Cohesion: 0.13
Nodes (14): @visibleForTesting, home_widget_data.dart, HomeWidgetService, init, _initialized, instance, launchRoute, listenForClicks (+6 more)
...
Cohesion: 0.13
Nodes (14): ../../../data/models/reading_plan.dart, home_widget_keys.dart, home_widget_service.dart, _collect, _continueReading, _dailyAyahPool, HomeWidgetSync, _inFlight (+6 more)
...
### Community 110 - "audioProvider"
Cohesion: 0.22
Nodes (10): audioProvider, playingSurahProvider, AudioPlayerBar, _Bar, build, planDayMarksProvider, _buildList, _isDayPlaying (+2 more)
...
Cohesion: 0.12
Nodes (15): AsyncValue, ../../../data/db/search_normalizer.dart, ayah, ayahNumber, fraction, progress, query, quran (+7 more)

### Community 124 - "legal_test.dart"
Cohesion: 0.18
Nodes (8): package:kuran_turkce_meal/core/router/app_shell.dart, package:kuran_turkce_meal/features/legal/data/legal_texts.dart, package:kuran_turkce_meal/features/legal/view/legal_document_screen.dart, package:kuran_turkce_meal/shared/widgets/tab_bar_inset.dart, RichText, main, insetIn, main
...
### Community 128 - "HomeScreen"
Cohesion: 0.53
Nodes (6): ayahOfTheDayProvider, filteredSurahListProvider, lastReadProvider, surahProgressProvider, build, HomeScreen

### Community 129 - "theme_test.dart"
Cohesion: 0.25
...
Cohesion: 0.33
Nodes (7): ConsumerStatefulWidget, rootDataProvider, ReaderScreen, rootSearchProvider, build, RootSearchScreen, _RootSearchScreenState
...
- **Why does `_` connect `_` to `home_widget_sync.dart`, `return`, `package:flutter_riverpod/flutter_riverpod.dart`, `plan_detail_screen.dart`, `core/providers/app_providers.dart`, `VoidCallback?`?**
